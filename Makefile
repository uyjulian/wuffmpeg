...
FFMPEG_LIBS := external/ffmpeg/$(DEPENDENCY_BUILD_DIRECTORY)/libavformat/libavformat.a external/ffmpeg/$(DEPENDENCY_BUILD_DIRECTORY)/libavcodec/libavcodec.a external/ffmpeg/$(DEPENDENCY_BUILD_DIRECTORY)/libswresample/libswresample.a external/ffmpeg/$(DEPENDENCY_BUILD_DIRECTORY)/libswscale/libswscale.a external/ffmpeg/$(DEPENDENCY_BUILD_DIRECTORY)/libavutil/libavutil.a
...
INCFLAGS += -Iexternal/ffmpeg -Iexternal/ffmpeg/$(DEPENDENCY_BUILD_DIRECTORY)

$(BASESOURCES): $(EXTLIBS)

$(FFMPEG_LIBS):
	cd external/ffmpeg && \
	mkdir -p $(DEPENDENCY_BUILD_DIRECTORY) && \
	cd $(DEPENDENCY_BUILD_DIRECTORY) && \
	../configure \
...
clean::
	rm -rf external/ffmpeg/$(DEPENDENCY_BUILD_DIRECTORY)
